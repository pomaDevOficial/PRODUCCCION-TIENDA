...
let ImpresionService = class ImpresionService {
    constructor() { }
    // Método para imprimir un documento PDF
    imprimir(entidad, encabezado, cuerpo, titulo, guardar) {
    ...
    async generarComprobante(comprobante, detallesVenta, tipoComprobante) {
        const doc = new jsPDF();
        try {
...
ImpresionService = __decorate([
    Injectable({
        providedIn: 'root',
    })
], ImpresionService);
export { ImpresionService };
