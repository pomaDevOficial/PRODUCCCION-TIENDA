...
let MarcaComponent = class MarcaComponent {
    marca;
    fb;
    messageService;
    confirmationService;
    ...
    constructor(marca, fb, messageService, confirmationService) {
        this.marca = marca;
        this.fb = fb;
    ...
    editarMarca(marca) {
        ...
        if (modal) {
            const modal1 = new window.bootstrap.Modal(modal);
            modal1.show();
        }
    }
    guardarMarca() {
